...
/**
 * *********** Autores *********** - Kevin Manuel Quintero Martinez, Legajo
 * FAI-2771 - Benjamín Morales, Legajo FAI-3370 - Angel Gabriel Avellaneda,
 * Legajo FAI-3242
 */
public class Lista {
    ...
    /* Borra el elemento de la posición pos, por lo que la cantidad de elementos de la lista disminuye en uno.
    Para una eliminación exitosa, la lista no debe estar vacía y la posición recibida debe ser 1 <= pos <= longitud(lista).
    ...
    /* Quita todos los elementos de la lista. Al ser nula la cabecera, no hay forma de 
    alcanzar los demás nodos enlazados, por lo que el garbage collector se los lleva */
    public void vaciar() {
        this.cabecera = null;
    }
    ...
    @Override
    public Lista clone() {
        Lista listaClonada = new Lista(); // crea una lista vacía
    ...
    /* Recorre la lista y devuelve true si tiene elementos repetidos. Caso contrario,
