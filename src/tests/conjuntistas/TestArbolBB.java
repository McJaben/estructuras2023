...
public class TestArbolBB {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "¿Pertenece 40? " + "espera:" + sOk + "--->" + (arbol.pertenece(40) ? sOk : sErr)); // true
        System.out.println(
                "¿Pertenece 80? " + "espera:" + sOk + "--->" + (arbol.pertenece(80) ? sOk : sErr)); // true
        ...
        System.out.println("Obteniendo el mínimo elemento del árbol " + "espera 20 y " + sOk
                + " ---> " + aux + (aux == 20 ? sOk : sErr));
        aux = arbol.maximoElem();
        System.out.println("Obteniendo el máximo elemento del árbol " + "espera 90 y " + sOk
                + " ---> " + aux + (aux == 90 ? sOk : sErr));
        ...
        System.out.println("Imprimiendo contenido del árbol");
        ...
        System.out.println(
                "Eliminando elemento 30, espera: " + sOk + " y [20,25,35,40,50,60,70,80,90]"
