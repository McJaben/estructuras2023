...
public class TestingLista {
	...
	public static void testLista() {
		...
		System.out
				.print("Inserta 5 pos 5 espera FALSE y lista vacia: \t" + ((l1.insertar(5, 5) == false) ? sOk : sErr));
		...
		System.out.println("\t--> " + l1.toString());
		System.out.print("Inserta 3 pos long+1 espera TRUE y [1,2,3]: \t"
				+ ((l1.insertar(3, l1.longitud() + 1) == true) ? sOk : sErr));
		System.out.println("\t--> " + l1.toString());
		...
		System.out.print("Inserta 10 pos long+2 espera FALSE y [1,2,3,4,5]: "
		...
		System.out.println("\t--> " + l1.toString());
		System.out.print(
				"Elimina ultimo espera TRUE y [2,3]: \t\t" + ((l1.eliminar(l1.longitud()) == true) ? sOk : sErr));
		System.out.println("\t--> " + l1.toString());
		...
		System.out.println();
		System.out.println("\n\n*****************************************");
		System.out.println("*     Test de OBTENER MÚLTIPLOS 	*");
		System.out.println("*****************************************\n");
		Lista caracteres = new Lista();
		char[] charArray = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J' };
		for (int k = 0; k < charArray.length; k++) {
			caracteres.insertar(charArray[k], caracteres.longitud() + 1);
		}
		System.out.println("Lista de caracteres debe imprimir: [A, B, C, D, E, F, G, H, I, J]" + " ---> "
				+ caracteres.toString());
